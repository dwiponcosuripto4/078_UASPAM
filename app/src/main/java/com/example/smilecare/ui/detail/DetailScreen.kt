...
object DetailDestination : DestinasiNavigasi {
    ...
    override val titleRes = "Detail Booking"
    const val bookingId = "itemId"
    val routeWithArgs = "$route/{$bookingId}"
}
...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        ItemDetails(
            booking  = detailUIState.addEvent.toBooking(), modifier = Modifier.fillMaxWidth()
        )
...
fun ItemDetails(
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                labelResID ="Jenis Perawatan",
                itemDetail = booking.jenisPerawatan,
